zeroplot <- function(returns, main="", xlab="",  up.col='goldenrod', dn.col='goldenrod4'){
  ...
  #png("1.png")
  #pdf("1.pdf")
  plot(dens, xlab=xlab, ylab=ylab, main=main, yaxt="n")
  ...
  legend("topleft", inset=.01,  legend=c(ups,downs), fill=c(up.col, dn.col), cex=.8)
